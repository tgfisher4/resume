...
{\em Proficient}: Python, Java, LaTeX, Bash, JavaScript, C, PHP, SQL \\ %\ & {\em Basic}: C++, Clojure, Scala, Gatling, Arduino, MATLAB,  PHP, SQL, Unity \\
{\em Basic}: C++, Clojure, Scala, Gatling, Docker, Kubernetes, Helm, Jenkins, Arduino, MATLAB, Verilog  \\
%Other \ & Latin, Cello \\
